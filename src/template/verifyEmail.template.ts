const passLink = (name: string, link: string) => {
  const registrationHTML = `
    ...
    <h2 class="header-text" style = "font-family: 'Lato'; text-align: center;padding-top:2rem; ">Managing your finances has never been so simple, take control with all in one investment, retirement, checking and more ...</h2>
    <h1 class="header-text" style = "font-family: 'Lato'; text-align: center;padding-top:2rem; ">Welcome to NIX Pay, where your finance dream comes to life!</h1>
    ...
    height: 90%; display:block;border-radius: 25px; ";
        class="imgClass"
        src=https://res.cloudinary.com/djaauazpo/image/upload/v1656022316/Dev/logo3_h7kbh5.jpg
      /></div>
    
      <h2 style = " margin: auto; padding:2rem;text-align: center; font-family: 'Lato';"  >Hi ${name}, <br>Activate your account to start your finance journey on NIX Pay.</h2>
  
    <div class="btnContainer" ><a href='${link}'style=" text-decoration: none; cursor: pointer; background-color: #FFA500; border: none; border-radius: 8px; 
    ...
    <h3  style="font-family: 'Lato'; padding:0rem 2rem;text-align: center;">Once active, your account is the gateway to our
      universe of money, assets and services that help you build your financial freedom.</h3>
    ...
    faster than you might think. Once verified, you can start making investment and embrace a better world.</h3><br></br>
    ...
    flex-direction: row; padding: 2rem;font-family: 'Lato'; ">
      ...
      <div>
        <p style="font-family: 'Lato';">Master the space with our sharp investment guides.
        </p>
      </div>
    </div>
    </div>
  
    <div> <p style=" text-align: center;font-family: 'Lato';" >Copyright &copy; 2022 Nix Bank, Inc.</p>
    </div>
    </div>
    `;
